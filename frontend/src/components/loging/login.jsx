    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box component="form" onSubmit={handleLogin} sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <Typography sx={{ fontFamily: 'Poppins', fontSize: '12px', color: '#00000080', mt: '30px', textAlign: 'center' }}>
                    ...
                    <Link href="/signup" underline="none" sx={{ color: '#00E783', fontWeight: 500 }}>
                        Sign Up
                    </Link>
                </Typography>
